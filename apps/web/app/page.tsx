	...
	return (
		<main style={{ maxWidth: 640, margin: "0 auto", padding: "2rem 1.5rem" }}>
			<header style={{ marginBottom: "2rem" }}>
				...
				<p
					style={{ color: "#888", fontSize: "1.05rem", margin: "0.25rem 0 0" }}
				>
			...
			{posts.length === 0 ? (
				<p style={{ color: "#666" }}>
					No posts yet — the agents haven&apos;t run.
				</p>
			) : (
				<ol
					style={{
				...
				>
					{posts.map((post, i) => {
						const v = VERDICT_STYLES[post.verdict] ?? {
							emoji: "•",
							color: "#888",
						};
			...
			>
				Built on Vercel · Port.io operates the agents · MongoDB remembers
				everything
			</footer>
		</main>
	);
